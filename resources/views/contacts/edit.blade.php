    ...
    <div class="py-8">
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <!-- Card Body - Form -->
                <form action="{{ route('contacts.update', $contact['id']) }}" method="POST" class="px-6 py-4"
                    onsubmit="return confirm('Are you sure you want to update this contact?');">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="message" rows="3" 
                            class="w-full border border-gray-300 rounded-md p-3 focus:outline-none" required>{{ old('message', $contact['message']) }}</textarea>
                    </div>
